...
namespace Tilo.Services
{
    public class ProductsService
    {
        ...
        public IEnumerable<string> Colors => new string[] { "чёрный", "белый", "красный", "зелёный", "синий", "айвори", "марсала", "оранжевый", "розовый", "желтый", "голубой", "изумрудный", "морская волна", "серый", "фиолетовый", "бежевый", "серебрянный", "золотой" };
